...
function updateChoropleth() {
        ...
        mapcolor.domain([d3.min(totalcrimes, function (d) {
                                ...
                                if (whichlod == "perCapita"){
                                        return 100000*(d.value[whichvar]/d.value["areapop"]);
                                }}),
                ...
                //.range(["#9015c5", "#f524c8", "#6c16ca", "#9015c5", "#f524c8"]);
                .range(["#f524c8", "#9015c5", "#6c16ca", "#4c01d5", "#2109c9"]);
        ...
        tip.html(function (d) {
                ...
                if (whichlod == "perCapita"){
                        return dataRow.area + ": " + format(100000*(dataRow["value"][whichvar])/(dataRow.value.areapop));
                }
        });
        ...
        svg.selectAll(".maplines")
            .attr("fill", function (d) {
                    ...
                    if (whichlod == "perCapita"){
                            return mapcolor(100000*((DatabyDistrict[d.properties.DISTRICT])["value"][whichvar])/((DatabyDistrict[d.properties.DISTRICT])["value"]["areapop"]));
                    }
            })
